...
export function getMemberGroupBadges({ status, sub, isSharedCredentials, flags }) {
  const { hasServiceInfoIssue, needsFillInfo, waitingForOthers, waitingForActivation, canConfirm, isDisputed, isDisputeRaiser, isDisputeEscalated, alreadyConfirmed, isInfoOverdue, isActivationOverdue } = flags
