...
- `/favorites` 收藏群組
- 通知中心點擊申請結果或待處理通知
- `/my-subscriptions` 查看審核中、處理中、服務中與歷史紀錄
...
- 通知中心的「新申請」「群組額滿」「成員資訊已填寫」「問題回報」等通知
...
| 成員逾期未填資料 | 成員被移出並釋出名額，團主與成員皆收到通知 |
| 團主逾時未啟用 | 系統自動退回額滿狀態或代為處理，避免流程被單方卡住 |
| 續訂時有人餘額不足 | 整批續訂失敗，團主看到不足名單 |
| 申訴進入平台介入 | 明確改變狀態文案，雙方知道已不再是一般確認期 |
