...
2. **鎖定群組**：名額額滿後，團主可以鎖定群組——建立聊天室、給成員一段期限提供帳號資訊；部分服務會要求團主自己先提供結構化的帳密資訊
3. **啟用服務**：全員提供帳號資訊後，團主逐一確認無誤才能啟用，進入一段確認期；啟用的同一刻才會確定下次扣款日，不分首次或續訂後啟用都是由團主依外部平台實際扣款日期自行填寫，通知全員；團主逾期未手動啟用時，系統會自動代為啟用，避免流程卡住
